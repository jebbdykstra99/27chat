(function () {
  ...
  let SITE_ID = '27chat';
  let site = null;
  let COLORS = ['#c4a574', '#8b6d3f', '#5c4a32', '#a89070', '#3a3238', '#6e5a42'];
  let TRENDS = [];
  let PLACES = [];
  let TOPICS = [];
  ...
  function syncProfile() {
    ...
    document.getElementById('profile-bio').textContent = currentUser.bio || "The work didn’t stop.";
  ...
  function wireEvents() {
    ...
    document.getElementById('cv-guest-login').addEventListener('click', function () { stubSignIn('Guest', 'guest27'); });
  ...
  fetch(SITE_JSON_URL)
    ...
    .catch(function (e) {
      ...
      boot({ siteId: "27chat", name: "27chat", tagline: "The work didn’t stop." });
    });
})();
